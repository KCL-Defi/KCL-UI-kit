...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/logowithouttext.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: isDark ? '/images/logo.png' : '/images/logo.png' })));
};
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { style: { background: "#A0A0A0" }, key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        ...
        React.createElement(SettingsEntry, null,
            React.createElement(Button, { style: { padding: "0rem 0.8rem 0rem 0.8rem" }, variant: "text", onClick: function () { return toggleTheme(!isDark); } },
